...
def compute_verdict(
    criterion: dict[str, Any], extraction: dict[str, Any], is_tampered_source: bool = False
) -> dict[str, Any]:
    """
    ...
    return {"status": "Eligible", "reason": "Requirement satisfied based on extracted evidence."}
